          ...
          <div class="thing-infos-view">
            <div class="thing-infos">
              ...
              <div class="thing-info-box">
                ...
                <a-space>
                  <a-button type="primary" @click="handleOrder(detailData)">
                    <img src="@/assets/images/add.svg" />
                    <span>立即购买</span>
                  </a-button>
                  <a-button @click="handleShopCarAdd(detailData)">
                    <template #icon>
                      <img src="@/assets/images/add.svg" />
                    </template>
                    <span>加入购物车</span>
...
// import { message } from 'node_modules/ant-design-vue/types/ant-design-vue'
import { message } from 'ant-design-vue';
import {createShopCarApi} from '@/api/index/shopCar'
...
export default {
  ...
  methods: {
    ...
    handleShopCarAdd (detailData) {
      const userId = this.$store.state.user.userId
      const data = {
        thing_id: detailData.id,
        count: 1,
        user_id: userId,
      }
      createShopCarApi(data).then(res => {
