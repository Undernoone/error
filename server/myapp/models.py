...
class Order(models.Model):
    ...
    things = models.JSONField(blank=True, null=True, default=list)
...
class ShopCar(models.Model):
    thing = models.ForeignKey(Thing, on_delete=models.CASCADE, null=True, related_name='thing_shopcar')
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True, related_name='user_shopcar')
    count = models.IntegerField(default=0)
